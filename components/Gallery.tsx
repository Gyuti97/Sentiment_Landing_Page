      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex justify-center items-center gap-6 md:gap-10 mb-20 border-b border-charcoal/10 pb-6 max-w-md mx-auto">
          <button
            ...
            className={`font-sans text-xs md:text-sm uppercase tracking-widest pb-2 transition-all duration-300 relative ${
              activeTab === 'finished' 
              ...
              >
                ...
                {navigate && (
                  <button
                    ...
                    className="bg-charcoal text-off-white font-sans text-xs uppercase tracking-widest px-8 py-4 hover:bg-charcoal/90 transition-all duration-300 font-medium hover:scale-[1.02] active:scale-[0.98]"
                  >
